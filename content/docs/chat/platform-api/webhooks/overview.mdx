...
- **Messages:** one-to-one and group sends, final message modification, database persistence, read status, and revocation. See [After a message is saved to the database](/platform-api/webhooks/message/after-message-save-db).
