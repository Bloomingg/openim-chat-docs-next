...
| status <span className="enterprise-field-badge">商业版</span> | int | 用户账号状态，用于账号治理和状态筛选。 |
| addFriendPermission <span className="enterprise-field-badge">商业版</span> | int | 用户的加好友权限设置。 |
