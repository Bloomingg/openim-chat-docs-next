...
相关页面包括[转发或合并消息](/sdk/ios/message/managing-messages/forward-or-merge-a-message)、[删除消息](/sdk/ios/message/managing-messages/delete-a-message)、[撤回消息](/sdk/ios/message/managing-messages/revoke-a-message)、[插入本地消息](/sdk/ios/message/managing-messages/insert-a-local-message)、[清理消息历史](/sdk/ios/message/managing-messages/clear-message-history)和[管理输入状态](/sdk/ios/message/composing-messages/manage-typing-status)。
...
固定 iOS SDK 没有公开 WASM 的消息修改、置顶会话消息、音频转写和定向群消息创建 API，不应在客户端文档中模拟这些能力。
